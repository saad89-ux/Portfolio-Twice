...
const IndustriesSection = ()=>{
    ...
    const [imgSrc, setImgSrc] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(industries[0].image);
                ...
                "IndustriesSection.useEffect": (entries)=>{
                    entries.forEach({
                        "IndustriesSection.useEffect": (entry)=>{
                            ...
                            }["IndustriesSection.useEffect"], 200);
                        }
                    }["IndustriesSection.useEffect"]);
                }
            }["IndustriesSection.useEffect"], {
...
_s(IndustriesSection, "+k7pMAnWQeT2nbM+tAdLGfqATRY=");
...
//# sourceMappingURL=_1cnmus8._.js.map