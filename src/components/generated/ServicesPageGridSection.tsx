...
const servicesGridData = [
  {
    ...
    graphic: (
      <div style={{ position: 'relative', width: '100%', height: '100%', display: 'flex', alignItems: 'flex-end', justifyContent: 'flex-end', paddingBottom: '20px' }}>
        <div style={{
          position: 'absolute', top: '20%', right: '40%', backgroundColor: 'var(--brand-500-soft)',
          border: '1px solid var(--brand-500-strong)', borderRadius: '8px', padding: '6px 12px',
          display: 'flex', flexDirection: 'column', alignItems: 'center'
        }}>
          <span style={{ color: 'var(--brand-500)', fontWeight: 800, fontSize: '16px', fontFamily: InterFont }}>+230%</span>
        ...
        <svg width="180" height="120" viewBox="0 0 180 120" style={{ overflow: 'visible' }}>
          ...
          <path d="M0 100 L 30 85 L 60 90 L 90 50 L 120 60 L 160 20 L 180 0" fill="none" stroke="var(--brand-500)" strokeWidth="3" filter="url(#lineGlow2)" />
          {[
            [0,100], [30,85], [60,90], [90,50], [120,60], [160,20], [180,0]
          ].map((pt, i) => (
            <circle key={i} cx={pt[0]} cy={pt[1]} r="4" fill="#050816" stroke="var(--brand-500)" strokeWidth="2" />
          ))}
        </svg>
      </div>
    )
  },
  {
    ...
    graphic: (
      <div style={{ position: 'relative', width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ position: 'absolute', width: '180px', height: '180px', borderRadius: '50%', border: '1px dashed var(--brand-500-strong)', animation: 'spin 20s linear infinite' }}></div>
        <div style={{ position: 'absolute', width: '120px', height: '120px', borderRadius: '50%', border: '1px solid var(--brand-500-strong)', animation: 'spin 15s linear infinite reverse' }}></div>
        <div style={{
          position: 'absolute', width: '70px', height: '70px', borderRadius: '50%',
          backgroundColor: 'var(--brand-500-soft)', border: '2px solid var(--brand-500)',
          display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center',
          boxShadow: '0 0 20px var(--brand-500-strong)'
        }}>
          <span style={{ color: 'var(--text-muted)', fontSize: '9px', fontFamily: BarlowFont, fontWeight: 700 }}>ROAS</span>
          <span style={{ color: 'var(--brand-500)', fontSize: '18px', fontWeight: 800, fontFamily: InterFont }}>8.6x</span>
        </div>
        <img src="https://i.pravatar.cc/100?img=33" style={{ position: 'absolute', top: '10%', right: '20%', width: '32px', height: '32px', borderRadius: '50%', border: '2px solid var(--brand-500)' }} />
        <img src="https://i.pravatar.cc/100?img=12" style={{ position: 'absolute', bottom: '15%', left: '15%', width: '36px', height: '36px', borderRadius: '50%', border: '2px solid var(--brand-500)' }} />
      </div>
    )
  },
  {
    ...
    graphic: (
      <div style={{ position: 'relative', width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'flex-end', paddingRight: '20px' }}>
        <div style={{
          ...
          backgroundColor: '#050816', border: '1px solid var(--brand-500-strong)', borderRadius: '12px',
          ...
          <div style={{ width: '40px', height: '4px', backgroundColor: 'var(--brand-500-strong)', borderRadius: '2px', marginBottom: '12px' }}></div>
          ...
          <div style={{ display: 'flex', gap: '8px' }}>
            <div style={{ flex: 1, height: '40px', backgroundColor: 'var(--brand-500-soft)', borderRadius: '6px' }}></div>
            <div style={{ flex: 1, height: '40px', backgroundColor: 'var(--brand-500-soft)', borderRadius: '6px' }}></div>
          </div>
        </div>
        <div style={{
    ...
    graphic: (
      <div style={{ position: 'relative', width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{
          ...
          border: '1px solid var(--brand-500-strong)', borderRadius: '16px',
          transform: 'perspective(500px) rotateY(-20deg) rotateX(10deg)',
          display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '16px',
          boxShadow: '-10px 20px 30px rgba(0,0,0,0.5), inset 0 0 20px var(--brand-500-medium)'
        }}>
          <div style={{ width: '48px', height: '48px', backgroundColor: 'var(--brand-500)', borderRadius: '12px', transform: 'rotate(45deg)' }}></div>
          <span style={{ color: 'var(--brand-500)', fontWeight: 800, fontSize: '12px', fontFamily: InterFont, letterSpacing: '0.1em' }}>BRAND</span>
        </div>
        <div style={{
          position: 'absolute', bottom: '20px', left: '20px',
          width: '50px', height: '50px', backgroundColor: 'var(--brand-500-soft)', border: '1px solid var(--brand-500)',
          borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center',
          color: 'var(--brand-500)', fontSize: '20px', fontWeight: 700, fontFamily: InterFont,
    ...
    graphic: (
      <div style={{ position: 'relative', width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <div style={{
          ...
          backgroundColor: 'var(--brand-500-soft)', border: '1px solid var(--brand-500-strong)', borderRadius: '16px',
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          transform: 'perspective(500px) rotateY(-10deg) rotateZ(-5deg)', boxShadow: '-5px 10px 20px rgba(0,0,0,0.4)'
        }}>
          <svg width="32" height="32" viewBox="0 0 24 24" fill="var(--brand-500)"><polygon points="8 5 19 12 8 19 8 5"></polygon></svg>
        </div>
        {/* Image Card */}
        <div style={{
          position: 'absolute', top: '30px', right: '20px', width: '80px', height: '80px',
          backgroundColor: 'var(--brand-500-medium)', border: '1px solid var(--brand-500-strong)', borderRadius: '16px',
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          transform: 'perspective(500px) rotateY(-10deg) rotateZ(10deg)', boxShadow: '-5px 10px 20px rgba(0,0,0,0.4)'
        }}>
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="var(--brand-500)" strokeWidth="2"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><polyline points="21 15 16 10 5 21"></polyline></svg>
        </div>
        {/* Text Card */}
        <div style={{
          position: 'absolute', bottom: '20px', left: '50px', width: '120px', height: '60px',
          backgroundColor: 'var(--brand-500-soft)', border: '1px solid var(--brand-500-strong)', borderRadius: '12px',
          ...
          <div style={{ width: '80%', height: '6px', backgroundColor: 'var(--brand-500-strong)', borderRadius: '3px' }}></div>
          <div style={{ width: '50%', height: '6px', backgroundColor: 'var(--brand-500-strong)', borderRadius: '3px' }}></div>
        </div>
      </div>
    )
  },
    ...
    graphic: (
      <div style={{ position: 'relative', width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <svg style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', zIndex: 0 }}>
          <path d="M 60 50 C 100 50, 100 100, 140 100" fill="none" stroke="var(--brand-500-strong)" strokeWidth="2" strokeDasharray="4 4" />
          <path d="M 140 100 C 100 100, 100 150, 60 150" fill="none" stroke="var(--brand-500-strong)" strokeWidth="2" strokeDasharray="4 4" />
        </svg>
        <div style={{
          position: 'absolute', top: '30px', left: '40px', width: '40px', height: '40px',
          backgroundColor: 'var(--brand-500)', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1
        }}>
        ...
        <div style={{
          ...
          backgroundColor: 'var(--brand-500-medium)', border: '1px solid var(--brand-500)', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1
        }}>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--brand-500)" strokeWidth="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
        </div>
        <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '40px' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', maxWidth: '600px' }}>
            ...
            <h2 style={{ margin: 0, color: 'var(--text-primary)', fontSize: 'clamp(36px, 4vw, 56px)', fontFamily: InterFont, fontWeight: 800, lineHeight: 1.1 }}>
              Growth solutions.<br/>
              Built for <i style={{ color: 'var(--brand-500)', fontStyle: 'italic', fontWeight: 700 }}>real impact.</i>
            </h2>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', maxWidth: '350px', alignItems: 'flex-start', paddingTop: '24px' }}>
            ...
            <button className="ca-hover-popup" style={{
              ...
              color: 'var(--brand-500)', fontSize: '13px', fontWeight: 700, fontFamily: BarlowFont, textTransform: 'uppercase', letterSpacing: '0.1em', cursor: 'pointer', padding: 0
            }}>
              EXPLORE ALL SERVICES
              <div style={{ width: '40px', height: '40px', borderRadius: '50%', backgroundColor: 'var(--brand-500-soft)', border: '1px solid var(--brand-500-strong)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          {servicesGridData.map((item, index) => (
            ...
            >
              ...
              <div style={{ position: 'absolute', top: 0, right: 0, width: '60%', height: '100%', zIndex: 0, pointerEvents: 'none', opacity: 0.8 }}>
                <div style={{ position: 'absolute', inset: 0, background: 'radial-gradient(circle at right, var(--brand-500-soft) 0%, transparent 70%)' }}></div>
                {item.graphic}
              </div>

              {/* Content area (left side) */}
              <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', height: '100%', maxWidth: '65%' }}>
                <span style={{ color: 'var(--brand-500)', fontSize: '14px', fontWeight: 800, fontFamily: InterFont, marginBottom: '24px' }}>
                  {item.id}
                </span>
                
                <div style={{ width: '48px', height: '48px', borderRadius: '12px', backgroundColor: 'var(--brand-500-soft)', border: '1px solid var(--brand-500-medium)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--brand-500)', marginBottom: '24px' }}>
                  {item.icon}
                </div>
                ...
                <div style={{ marginTop: 'auto', display: 'flex', alignItems: 'center', gap: '12px', color: 'var(--brand-500)', fontSize: '12px', fontWeight: 700, fontFamily: BarlowFont, letterSpacing: '0.1em' }}>
                  LEARN MORE
                  <div style={{ width: '28px', height: '28px', borderRadius: '50%', border: '1px solid var(--brand-500-strong)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          {stats.map((stat, i) => (
            <React.Fragment key={i}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                <div style={{ color: 'var(--brand-500)', opacity: 0.8 }}>{stat.icon}</div>
